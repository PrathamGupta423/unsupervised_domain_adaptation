...
\begin{table}[h]
  ...
  \begin{tabular}{ll}
      ...
      Computer Vision (Categorical) & Office-31: Amazon, DSLR, Webcam \\
...
% \textbf{Results:} We observed that ATT performs particularly well on digit classification tasks, showing significant improvement over baseline methods. The pseudo-labeling strategy proves effective in transferring knowledge from source to target domain.
\section{Conclusion}
