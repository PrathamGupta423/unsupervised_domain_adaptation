...
\begin{itemize}
  \item \textbf{MMD (Maximum Mean Discrepancy)}[]: 
  ...
  \item \textbf{ATT (Adversarial Training with Triplet loss)}[]: 
\end{itemize}
...
% \begin{itemize}
%   \item \textbf{Computer Vision (Numbers)}: MNIST, MNIST-M, SVHN
%   \item \textbf{Computer Vision (Categorical)}: Office31, Amazon, DSLR, Webcam
%   \item \textbf{Sentiment Analysis (Classification)}: Amazon Review Sentiment
% \end{itemize}
