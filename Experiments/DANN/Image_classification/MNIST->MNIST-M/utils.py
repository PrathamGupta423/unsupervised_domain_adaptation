...
def save_model(encoder, classifier, discriminator, training_mode):
    print('Saving models ...')
    save_folder = 'trained_models_14april'
    if not os.path.exists(save_folder):
        os.makedirs(save_folder)

    torch.save(encoder.state_dict(), 'trained_models_14april/encoder_' + str(training_mode) + '.pt')
    torch.save(classifier.state_dict(), 'trained_models_14april/classifier_' + str(training_mode) + '.pt')

    if training_mode == 'dann':
        torch.save(discriminator.state_dict(), 'trained_models_14april/discriminator_' + str(training_mode) + '.pt')
